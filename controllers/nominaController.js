...
exports.crearNomina = catchAsync(async (req,res,next) =>{
    ...
    const empleado = await employeesModel.findById(req.body.Empleados).populate({
        path:'Nominas'
    }).populate({
        path:'Vacaciones'
    })
    ...
    if(req.body.nombreNomina.split(' ')[0] === 'Diciembre'){
        req.body.regalia = calcularNomina.regalia(empleado.createdAt,empleado.sueldoFijo)
    }


    let calculos;
   if(req.body.tipoDeNomina === 'Nomina Fija'){
        calculos = calcularNomina.nomina(req.body.sueldoFijo,0,req.body.tipoDeNomina,req.body.salarioPorVacaciones,req.body.regalia)
    }else{
       ...
       calculos = calcularNomina.nomina(req.body.sueldoFijo,totalSalario,req.body.tipoDeNomina,req.body.salarioPorVacaciones,req.body.regalia)
    }
